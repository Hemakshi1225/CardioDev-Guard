"""
analyzers/qa_analyzers.py — Vanshika's QA-domain analyzer functions
====================================================================
...
Functions
---------
analyze_missing_values   — detect NaN values in CSV files
analyze_duplicates       — detect duplicate rows in CSV files
analyze_class_imbalance  — detect class imbalance in binary target column
analyze_model_metrics    — evaluate loaded model ROC-AUC / accuracy
analyze_leakage          — detect feature-target correlation leakage
...
def analyze_class_imbalance(
    ...
    for csv_path in request.data_files:
        ...
        if target_column not in df.columns:
            continue  # not a labelled dataset — skip silently
